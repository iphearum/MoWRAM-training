                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center">
                                <div class="p-5">
                                    ...
                                    <p>This card comes from the static portfolio template and is now rendered by a Laravel Blade page.</p>
                                </div>
                                <img class="img-fluid" src="https://dummyimage.com/300x400/343a40/6c757d" alt="Project placeholder" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center">
                                <div class="p-5">
                                    ...
                                    <p>Use this second card to practice repeating Bootstrap card layouts in a Blade view.</p>
                                </div>
                                <img class="img-fluid" src="https://dummyimage.com/300x400/343a40/6c757d" alt="Project placeholder" />
                            </div>
                        </div>
